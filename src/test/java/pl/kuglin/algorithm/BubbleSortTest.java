...
public class BubbleSortTest {
    ...
    public void sortIncreasingOrderIntArray() {
        ...
        ComparisonSortingAlgorithm<Integer> bubbleSort = new BubbleSort<>();
    ...
    public void sortIncreasingOrderDoubleArray() {
        ...
        ComparisonSortingAlgorithm<Double> bubbleSort = new BubbleSort<>();

        for (int i = 0; i < TESTED_EXAMPLES; i++) {

            initArrayDouble();

            bubbleSort.sort(arrayDouble);
    ...
    public void sortDecreasingOrderIntArray() {
        ...
        for (int i = 0; i < TESTED_EXAMPLES; i++) {
            ...
            bubbleSort.sort(arrayInteger, Collections.reverseOrder());
    ...
    public void sortDecreasingOrderDoubleArray() {
        ...
        for (int i = 0; i < TESTED_EXAMPLES; i++) {
            ...
            bubbleSort.sort(arrayDouble, Collections.reverseOrder());
    ...
    public void sortDecreasingOrderIntList() {
        ...
        for (int i = 0; i < TESTED_EXAMPLES; i++) {
            ...
            bubbleSort.sort(listInteger, Collections.reverseOrder());
    ...
    public void sortDecreasingOrderDoubleList() {
        ...
        for (int i = 0; i < TESTED_EXAMPLES; i++) {
            ...
            bubbleSort.sort(listDouble, Collections.reverseOrder());
