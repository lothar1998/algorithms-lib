...
public class QuickSortTest {
    ...
    public void sortIncreasingOrderIntArray() {
        ...
        ComparisonSortingAlgorithm<Integer> quickSort = new QuickSort<>();
    ...
    public void sortIncreasingOrderDoubleArray() {
        ...
        ComparisonSortingAlgorithm<Double> quickSort = new QuickSort<>();
    ...
    public void sortDecreasingOrderIntArray() {
        ...
        for (int i = 0; i < TESTED_EXAMPLES; i++) {
            ...
            quickSort.sort(arrayInteger, Collections.reverseOrder());
    ...
    public void sortDecreasingOrderDoubleArray() {
        ...
        for (int i = 0; i < TESTED_EXAMPLES; i++) {
            ...
            quickSort.sort(arrayDouble, Collections.reverseOrder());
    ...
    public void sortDecreasingOrderIntList() {
        ...
        for (int i = 0; i < TESTED_EXAMPLES; i++) {
            ...
            quickSort.sort(listInteger, Collections.reverseOrder());
    ...
    public void sortDecreasingOrderDoubleList() {
        ...
        for (int i = 0; i < TESTED_EXAMPLES; i++) {
            ...
            quickSort.sort(listDouble, Collections.reverseOrder());
