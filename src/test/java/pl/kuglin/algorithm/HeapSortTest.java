...
public class HeapSortTest {
    ...
    public void sortIncreasingOrderIntArray() {
        ...
        ComparisonSortingAlgorithm<Integer> heapSort = new HeapSort<>();
    ...
    public void sortIncreasingOrderDoubleArray() {
        ...
        ComparisonSortingAlgorithm<Double> heapSort = new HeapSort<>();

        for (int i = 0; i < TESTED_EXAMPLES; i++) {

            initArrayDouble();

            heapSort.sort(arrayDouble);
    ...
    public void sortDecreasingOrderIntArray() {
        ...
        for (int i = 0; i < TESTED_EXAMPLES; i++) {
            ...
            heapSort.sort(arrayInteger, Collections.reverseOrder());
    ...
    public void sortDecreasingOrderDoubleArray() {
        ...
        for (int i = 0; i < TESTED_EXAMPLES; i++) {
            ...
            heapSort.sort(arrayDouble, Collections.reverseOrder());
    ...
    public void sortDecreasingOrderIntList() {
        ...
        for (int i = 0; i < TESTED_EXAMPLES; i++) {
            ...
            heapSort.sort(listInteger, Collections.reverseOrder());
    ...
    public void sortDecreasingOrderDoubleList() {
        ...
        for (int i = 0; i < TESTED_EXAMPLES; i++) {
            ...
            heapSort.sort(listDouble, Collections.reverseOrder());
